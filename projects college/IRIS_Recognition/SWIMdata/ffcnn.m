...
Fcnndata=zeros(60,480,size(PPData,3));
Tcnndata=zeros(60,480,size(NPData,3));
for kk=1:size(PPData,3)
    [Fdata,Tdata]=CNN_Data(PPData(:,:,kk),NPData(:,:,kk));
    Fcnndata(:,:,kk)=Fdata;
    Tcnndata(:,:,kk)=Tdata;
end
cnn.cnndata1=Fcnndata;
cnn.cnndata2=Tcnndata;
